...
namespace Symbioz.World.Models.Entities.Look
{
    ...
    public class YAXLookSerializer : ICustomSerializer<ContextActorLook>
    {
        ...
        public ContextActorLook? DeserializeFromAttribute(XAttribute attribute, ISerializationContext serializationContext)
        {
        ...
        public ContextActorLook? DeserializeFromElement(XElement element, ISerializationContext serializationContext)
        {
            throw new NotImplementedException();
        }
        ...
        public ContextActorLook? DeserializeFromValue(string value, ISerializationContext serializationContext)
        {
            throw new NotImplementedException();
        }
        ...
        public void SerializeToAttribute(ContextActorLook objectToSerialize, XAttribute attrToFill, ISerializationContext serializationContext)
        {
            throw new NotImplementedException();
        }
        ...
        public void SerializeToElement(ContextActorLook objectToSerialize, XElement elemToFill, ISerializationContext serializationContext)
        {
            throw new NotImplementedException();
        }
        ...
        public string SerializeToValue(ContextActorLook objectToSerialize, ISerializationContext serializationContext)
        {
            throw new NotImplementedException();
        }
    }
